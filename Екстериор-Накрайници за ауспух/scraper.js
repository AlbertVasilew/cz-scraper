...
axios.get(`${siteDir}/%D0%9D%D0%B0%D1%87%D0%B0%D0%BB%D0%BE/1/2/37/null/`,{
    ...
    const products = category('.row').map(async (_, productRow) => {
        ...
        if(isAvailable) {
            ...
            return {
                ...
                "Промоционална цена:": "",
                "Редовна цена:": price,
                "Категории": "Екстериор, Екстериор > Накрайници за ауспух",
                "Етикети": "",
                "Клас на доставка": "",
                ...
                "Мета: rank_math_primary_product_cat": '860',
